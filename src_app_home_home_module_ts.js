...
let HomePage = class HomePage {
    constructor() {
        this.inputText = 'An easy way to convert text to voice that’s fast and straightforward – it’ll make your message more catchy and inclusive.';
        this.voices = [];
    ...
    getSupportedVoices() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield _capacitor_community_text_to_speech__WEBPACK_IMPORTED_MODULE_2__.TextToSpeech.getSupportedVoices().then((x) => {
                console.log('🚀 ~ file: home.page.ts ~ line 25 ~ HomePage ~ getSupportedVoices ~ data', x);
